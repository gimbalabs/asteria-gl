...
export default function MineAsteria({assets}: {assets: AssetExtended[]}){
    ...
    return (
        ...
        <div>
            ...
            <button onClick={handleSubmitMineAsteria} className={`inline-block px-6 py-3 text-white font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2`}></button>
