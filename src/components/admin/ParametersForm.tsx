...
*/
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <form onSubmit={handleSubmit} className="form font-bold text-galaxy-info">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-galaxy-light">
            {walletItems?.map((i) => {
              const { adminToken, assetName, assetNameReadable } = splitUnit(
                i.unit,
              );
              return (
                <DropdownMenuCheckboxItem
        ...
        <input readOnly value={adminToken} className="p-1" />

        <p>Admin Token Name (auto fills)</p>
        <input readOnly value={assetNameReadable} className="p-1" />
